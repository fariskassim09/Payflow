    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-secondary/50 rounded-2xl p-4 space-y-3">
          ...
          <div className="h-px bg-border" />
          <p className="text-xs text-accent font-medium">✓ Synced with Google Account</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-destructive/10 text-destructive border border-destructive/20 rounded-xl hover:bg-destructive/20 transition-all duration-300 font-medium disabled:opacity-50"
        >
          <LogOut size={18} />
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-accent text-accent-foreground rounded-xl hover:bg-accent/90 transition-all duration-300 font-medium disabled:opacity-50 active:scale-95"
      >
      ...
      <p className="text-xs text-secondary-foreground text-center">
        Your salary data will be synced to your Google account
      </p>
    </div>
  );
}
