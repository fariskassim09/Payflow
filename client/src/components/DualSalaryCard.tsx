  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-accent to-accent/80 rounded-3xl p-6 text-white relative overflow-hidden">
        ...
        <h2 className="text-3xl font-bold mb-4">RM {midSalary.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h2>
        ...
        <div className="grid grid-cols-3 gap-3 text-sm">
          <div>
            ...
            <p className="font-semibold">RM {midAllocatedAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div>
            <p className="text-xs opacity-80 mb-1">Remaining</p>
            <p className="font-semibold">RM {midRemainingAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div>
            <p className="text-xs opacity-80 mb-1">Allocated</p>
            <p className="font-semibold">{midTotalAllocated}%</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-accent to-accent/80 rounded-3xl p-6 text-white relative overflow-hidden">
        ...
        <h2 className="text-3xl font-bold mb-4">RM {endSalary.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h2>
        ...
        <div className="grid grid-cols-3 gap-3 text-sm">
          <div>
            <p className="text-xs opacity-80 mb-1">Allocated</p>
            <p className="font-semibold">RM {endAllocatedAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div>
            <p className="text-xs opacity-80 mb-1">Remaining</p>
            <p className="font-semibold">RM {endRemainingAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div>
            <p className="text-xs opacity-80 mb-1">Allocated</p>
            <p className="font-semibold">{endTotalAllocated}%</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-3xl p-6 animate-fade-in">
        ...
        <h3 className="text-2xl font-bold text-foreground mb-4">RM {totalSalary.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-xs text-secondary-foreground mb-1">Total Remaining</p>
            <p className="text-lg font-semibold text-accent">RM {totalRemaining.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div>
            <p className="text-xs text-secondary-foreground mb-1">Total Allocated</p>
            <p className="text-lg font-semibold text-foreground">{((midTotalAllocated + endTotalAllocated) / 2).toFixed(1)}%</p>
          </div>
        </div>
      </div>
    </div>
